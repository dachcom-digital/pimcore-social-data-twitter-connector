...
class ConnectorDefinition implements ConnectorDefinitionInterface
{
    ...
    public function setDefinitionConfiguration(array $definitionConfiguration)
    {
        ...
        try {
            ...
            throw new \Exception(sprintf('Invalid "%s" connector configuration. %s', 'twitter', $e->getMessage()));
        }
    }
    ...
    public function isConnected()
    {
        ...
        return $configuration->getAccessToken() !== null
            && $configuration->getAccessTokenSecret() !== null
            && $configuration->getApiKey() !== null
            && $configuration->getApiSecretKey() !== null;
    }
